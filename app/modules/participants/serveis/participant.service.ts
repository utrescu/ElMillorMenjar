...
export class ParticipantService {
  ...
  getParticipants(): Observable<Participant[]> {
    ...
    return this.http.get<Participant[]>(baseURL + "participants.json", {
      headers: headers
    });
    //        .map(res => res );
  }
  ...
  votaParticipant(data: Participant) {
    ...
    firebase.update("/participants/" + data.id, vots);
  }
  ...
  startMonitorResultats() {
    ...
    return firebase
      ...
      .then(listeners => (this.listeners = listeners));
  }
